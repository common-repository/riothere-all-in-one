...
function get_wishlist_email($product_ids, $customer_name, $header, $footer)
{
              ...
              <div class="shopping-bag" style="">
                <table style="width:100%; border-spacing:0 10px;">
                  <tr style="background:#f7f7f7; color:gray; font-size:14px; font-weight:600; height:30px;">
                    ...
                    <td style="padding-left:15px;">Old Price</td>
                    <td style="padding-left:15px;">Sale Price</td>
                  </tr>
                  <?php
    ...
    foreach ($product_ids as $product_id) {
        ...
        ?>
                      <tr>
                        ...
                        <td style="padding-left:15px;"><?php echo "AED " . esc_textarea($current_product['priceBeforePromotion']) ?></td>
