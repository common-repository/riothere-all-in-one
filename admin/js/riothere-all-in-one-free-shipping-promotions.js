(function ($) {
  "use strict";
  const promotionsData = window.riothere_admin_free_shipping_promotions_global;
  const isAddPage = $('input[name="is_add_mode"]').val() === "true";
  const promotionID = $('input[name="free_shipping_promotion_id"]').val();

  if (isAddPage) {
    // setActionsButtonStatus({disabled: true});
  }
  setupFields();
  $(".post-type-riothere-free-shipping-promotion form").on(
    "submit",
    function (event) {
  ...
  $(".free-shipping-filter-products-btn").on("click", function () {
  ...
  function getProducts() {
    ...
    $(
      ".post-type-riothere-free-shipping-promotion .free-shipping-filter-products-btn"
    ).prop("disabled", true);
    ...
    $.ajax({
      ...
      data: {
        action: "free_shipping_promotions_get_products",
        ajax_nonce: promotionsData.free_shipping_promotions_nonce,
        include: filters.include,
        exclude: filters.exclude,
        free_shipping_promotion_id: promotionID,
      ...
      success: function (data) {
        ...
        $(
          ".post-type-riothere-promotion .free-shipping-filter-products-btn"
        ).prop("disabled", false);
      },
  ...
  function updateProductsList(type = "include") {
    ...
    $.ajax({
      ...
      url: promotionsData.ajax_url,
      data: {
        action: "free_shipping_promotions_get_products_by_rules",
        ajax_nonce: promotionsData.free_shipping_promotions_nonce,
        ...rules,
      },
      success: function (data) {
  ...
  function setupFields() {
    ...
    const excludeMinPrice = $(
      "#free_shipping_promotions_settings #exclude_product_min_price"
    );
    const excludeMaxPrice = $(
      "#free_shipping_promotions_settings #exclude_product_max_price"
    );
    ...
    $("#free_shipping_promotions_settings .edit-promotion-settings-btn").on(
      "click",
      function (event) {
    ...
    $("#free_shipping_promotions_settings .edit-promotion-rules-btn").on(
      "click",
      function (event) {
    ...
    $("#free_shipping_promotions_settings .edit-promotion-products-btn").on(
      "click",
      function (event) {
  ...
  function handleSwitchToEditMode(event, mode = "settings") {
    ...
    if (mode === "settings") {
      $(
        '#free_shipping_promotions_settings input[name="edit-promotion-settings"]'
      ).val("true");
      $(
        "#free_shipping_promotions_settings .section#promotion-view-settings"
      ).removeClass("section-active");
      $(
        "#free_shipping_promotions_settings .section#promotion-edit-settings"
      ).addClass("section-active");
      $(
        "#free_shipping_promotions_settings .promotion-btn.edit-promotion-rules-btn"
      ).remove();
    } else if (mode === "rules") {
      $(
        '#free_shipping_promotions_settings input[name="edit-promotion-rules"]'
      ).val("true");
      $(
        '#free_shipping_promotions_settings input[name="edit-promotion-settings"]'
      ).val("true");
      $(
        "#free_shipping_promotions_settings .section#promotion-view-rules"
      ).removeClass("section-active");
      $(
        "#free_shipping_promotions_settings .section#promotion-view-included-products"
      ).removeClass("section-active");
      $(
        "#free_shipping_promotions_settings .section#promotion-edit-rules"
      ).addClass("section-active");
      $(
        "#free_shipping_promotions_settings .section#promotion-view-settings"
      ).removeClass("section-active");
      ...
      $(
        '#free_shipping_promotions_settings input[name="promotion-view-included-products_status"]'
      ).val("true");
      $(
        "#free_shipping_promotions_settings .promotion-btn.edit-promotion-rules-btn"
      ).remove();
      $(
        "#free_shipping_promotions_settings #promotion-view-included-products .promotion-h2 span"
      ).html("Edit Mode");
      ...
      $([document.documentElement, document.body]).animate(
        {
          scrollTop:
            $(
              "#free_shipping_promotions_settings #promotion-view-included-products"
            ).offset().top - 100,
        },
        1000
      );
    } else {
      $("#free_shipping_promotions_settings .section").removeClass(
        "section-active"
      );
      $("#free_shipping_promotions_settings .section#promotion-edit").addClass(
        "section-active"
      );
    }
  }
  ...
  function setActionsButtonStatus({ disabled }) {
    ...
    $(".post-type-riothere-promotion .free-shipping-filter-products-btn").prop(
      "disabled",
      disabled === true
    );
  }
